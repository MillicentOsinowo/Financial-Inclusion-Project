...
st.markdown("<h4 style='text-align: center; margin-top: 0rem; color: #32407B;'>BUILT BY MILLICENT</h4>", unsafe_allow_html=True)

st.image('pngwing.com (4).png', width=250, use_column_width=True)
...
st.sidebar.image('pngwing2.com.png', width=100, use_column_width=True, caption='Welcome User')
st.markdown("<br>", unsafe_allow_html=True)
